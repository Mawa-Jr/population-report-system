...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // Report 4
        System.out.println("\n--- REPORT 4: Capital Cities by Continent ---");
    ...
    public static void getCapitalsByContinent() {
        ...
        // Make it case-insensitive by matching against known continent names
        ...
        String sql = "SELECT city.Name, city.CountryCode, city.Population " +
                "FROM city " +
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            System.out.printf("\n%-40s %-15s %-15s%n",
                    "Capital City", "Country Code", "Population");
            System.out.println("--------------------------------------------------------");
            ...
            while (rs.next()) {
                ...
                System.out.printf("%-40s %-15s %-15d%n",
